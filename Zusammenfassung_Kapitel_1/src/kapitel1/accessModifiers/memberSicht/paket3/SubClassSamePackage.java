package kapitel1.accessModifiers.memberSicht.paket3;

public class SubClassSamePackage extends VisibilitySamePackage{
...
//		//Zugriff ueber eine Referenzvariable
		VisibilitySamePackage vClass = new VisibilitySamePackage();
