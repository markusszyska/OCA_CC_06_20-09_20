...
public class FarmMain {
	public static void main(String[] args) {
		...
		// Baby testing
		System.out.println("\n=======breeding tests=========");
		ALivestock piggy1 = pig1.procreate(pig3);
		ALivestock piggy2 = pig1.procreate(pig2);
		ALivestock cowie1 = cow1.procreate(cow3);
		ALivestock cowie2 = cow1.procreate(cow2);
