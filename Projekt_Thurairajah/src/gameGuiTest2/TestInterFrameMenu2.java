...
public class TestInterFrameMenu2 implements MouseListener{
	
	JInternalFrame jiFrame2 = new JInternalFrame();
	...
	JLabel p2ChooseCharTxt = new JLabel();
...
//			nameLabel.setIcon(image);
			...
			//Pp2ChooseCharTxt
			p2ChooseCharTxt.setText("Choose CPU Character");
			p2ChooseCharTxt.setBounds(780,10,480,60);
			p2ChooseCharTxt.setFont(new Font("Airstrike", Font.PLAIN,30));
			p2ChooseCharTxt.setForeground(Color.WHITE);
...
//			nameEnterBtn.addActionListener(btnAction());;
			...
			//INTERNAL FRAME2
			jiFrame2.setBounds(0, 0, 1200, 720);			
			jiFrame2.isResizable();
			jiFrame2.isMaximizable();
			jiFrame2.isIconifiable();
			jiFrame2.setVisible(true);
	
			ActionListener al = new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent e) {
					//PLAYER ONE NAME SHOWN IN LABEL
